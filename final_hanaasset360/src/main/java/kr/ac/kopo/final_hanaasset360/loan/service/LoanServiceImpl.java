...
import kr.ac.kopo.final_hanaasset360.loan.strategy.ByAvgIntRateStrategy;
import kr.ac.kopo.final_hanaasset360.loan.strategy.ByLoanLimAmtStrategy;
import kr.ac.kopo.final_hanaasset360.loan.strategy.LoanProductStrategy;
...
import kr.ac.kopo.final_hanaasset360.loan.repository.LoanRepository;
...
public class LoanServiceImpl implements LoanService {
    ...
    public List<LoanProductVO> getLoanProducts(String sort) {
        LoanProductStrategy strategy;

        switch (sort) {
            case "avgIntRate":
                strategy = new ByAvgIntRateStrategy(loanDAO);
                break;
            case "loanLimAmt":
                strategy = new ByLoanLimAmtStrategy(loanDAO);
                break;
            default:
                strategy = new ByAvgIntRateStrategy(loanDAO);
                break;
